...
function LinkPreview({ url, tripId, own, onLoad }: LinkPreviewProps) {
  ...
  return (
    ...
    >
      {data.image && (
        <img src={getAssetUrl(data.image)} alt="" style={{ width: '100%', height: 140, objectFit: 'cover', display: 'block' }}
                ...
                <div style={{
                  ...
                  {!own && (
                    <div style={{ width: 28, flexShrink: 0, alignSelf: 'flex-end' }}>
                      {showAvatar && (
                        msg.user_avatar ? (
                          <img src={getAssetUrl(msg.user_avatar)} alt="" style={{ width: 28, height: 28, borderRadius: '50%', objectFit: 'cover' }} />
                        ) : (
                          <div style={{
