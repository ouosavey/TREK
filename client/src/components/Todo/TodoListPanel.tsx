                    ...
                    <div style={{ display: 'flex', gap: 5, marginTop: 5, flexWrap: 'wrap' }}>
                      ...
                      {assignedUser && (
                        <span style={{
                          ...
                          {assignedUser.avatar ? (
                            <img src={getAssetUrl(`/uploads/avatars/${assignedUser.avatar}`)} style={{ width: 13, height: 13, borderRadius: '50%', objectFit: 'cover' }} alt="" />
                          ) : (
          ...
          <CustomSelect
            ...
            options={[
              ...
              ...members.map(m => ({
                ...
                label: m.username,
                icon: m.avatar ? (
                  <img src={getAssetUrl(`/uploads/avatars/${m.avatar}`)} style={{ width: 18, height: 18, borderRadius: '50%', objectFit: 'cover' as const }} alt="" />
                ) : (
