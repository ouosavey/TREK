            ...
            return (
              ...
              >
                <div style={{
                  ...
                  {tm.avatar_url
                    ? <img src={getAssetUrl(tm.avatar_url)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {avatarUrl ? <img src={getAssetUrl(avatarUrl)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : username?.[0]?.toUpperCase()}
      </div>
    </div>
  )
}
