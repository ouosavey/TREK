          ...
          return (
            <div key={member.id}
              ...
              <div style={{
                ...
                {(member.avatar_url || member.avatar) ? <img src={getAssetUrl(member.avatar_url || `/uploads/avatars/${member.avatar}`)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : member.username?.[0]?.toUpperCase()}
              </div>
