...
import { getApiBaseUrl, getAssetUrl } from '../../utils/serverConfig'
                                ...
                                <div style={{ marginTop: 3, display: 'flex', alignItems: 'center', gap: -4 }}>
                                  {assignment.participants.slice(0, 5).map((p, pi) => (
                                    <div key={p.user_id} style={{
                                      ...
                                      {p.avatar ? <img src={getAssetUrl(`/uploads/avatars/${p.avatar}`)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : p.username?.[0]?.toUpperCase()}
                                    </div>
                                  ))}
