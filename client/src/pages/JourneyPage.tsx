                ...
                >
                  ...
                  {activeJourney.cover_image && (
                    <div className="absolute inset-0 z-[1]">
                      <img src={getAssetUrl(activeJourney.cover_image)} className="w-full h-full object-cover" alt="" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-12 h-12 rounded-lg flex-shrink-0 overflow-hidden" style={{ background: pickGradient(trip.id) }}>
                        {trip.cover_image && (
                          <img src={getAssetUrl(trip.cover_image)} className="w-full h-full object-cover" alt="" />
                        )}
                      </div>
  ...
  return (
    ...
    >
      ...
      <div className="h-[170px] relative overflow-hidden" style={{ background: pickGradient(j.id) }}>
        {j.cover_image && (
          <>
            <img src={getAssetUrl(j.cover_image)} className="absolute inset-0 w-full h-full object-cover" alt="" />
