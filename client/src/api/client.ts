...
export const adminApi = {
  ...
  getAmapWebServiceKey: () => apiClient.get('/admin/amap-web-service-key').then(r => r.data),
  updateAmapWebServiceKey: (key: string) => apiClient.put('/admin/amap-web-service-key', { key }).then(r => r.data),
  getAmapKey: () => apiClient.get('/admin/amap-key').then(r => r.data),
  updateAmapKey: (key: string) => apiClient.put('/admin/amap-key', { key }).then(r => r.data),
  getAmapSecurityCode: () => apiClient.get('/admin/amap-security-code').then(r => r.data),
  updateAmapSecurityCode: (code: string) => apiClient.put('/admin/amap-security-code', { code }).then(r => r.data),
